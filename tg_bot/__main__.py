...
def settings_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            chat = bot.get_chat(chat_id)
            query.message.reply_text("Hai! Ada beberapa pengaturan untuk {} - lanjutkan dan pilih "
            ...
            chat = bot.get_chat(chat_id)
            query.message.reply_text(text="Hai! Ada beberapa pengaturan untuk {} - lanjutkan dan pilih "
